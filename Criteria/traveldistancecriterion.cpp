...
double TravelDistanceCriterion::evaluate(Pose &p, dummy::Map *map, ros::ServiceClient* path_client) {
  //cout << "travel " << endl;
  Astar astar;
...
double TravelDistanceCriterion::getPathLen(std::vector<geometry_msgs::PoseStamped> poses)
{
  double len=0;
