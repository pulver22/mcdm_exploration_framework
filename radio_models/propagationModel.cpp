...
const double ANTENNA_LOSSES_LIST[24] = {
    -25.2, -25,   -20.2, -17.6, -15.6, -14,   -11.2, -7.8,
    -5.2,  -2.4,  -0.6,  0,     -0.6,  -2.4,  -5.2,  -8.8,
    -12.2, -16.4, -19.2, -20.8, -24.4, -28.2, -24,   -22.6};
 ...
 */
double received_power_friis(double tag_x, double tag_y, double freq,
                            double txtPower) {
  double phi;
  double r;
 ...
 */
void activeAreaFriis(double freq, double txtPower, double sensitivity,
                     double distStep, double &minX, double &minY, double &maxX,
                     double &maxY) {
