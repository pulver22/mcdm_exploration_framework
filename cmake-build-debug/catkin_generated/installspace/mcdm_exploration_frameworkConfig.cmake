...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mcdm_exploration_framework' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /usr/local/lib;/home/pulver/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/devel/lib;/home/pulver/catkin_workspace/install/lib;/home/pulver/ncnr_ws/devel/lib;/opt/ros/kinetic/lib)
